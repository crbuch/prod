...
function Curve(d){
  ...
  var days30 = site_date.slice(0,d);
  var oil30 = site_oil.slice(0,d);
  var gas30 = site_gas.slice(0,d);
  var water30 = site_water.slice(0,d);
  var comments30 = comments.slice(0,d);
  var movingAverage30 = movingAverage.slice(0,d);
  //console.log(days30);
...
d3.select("#Days30").on('click', function() {Curve(d=31);});
d3.select("#Days180").on('click', function() {Curve(d=181);});
d3.select("#Days365").on('click', function() {Curve(d=366);});
